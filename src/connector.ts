...
export class Connector {
  options: { port?: number, host?: string, localAddress?: string, socketStreamFactory?: () => stream.Duplex };
  multiSubnetFailover: boolean;

  constructor(options: { port?: number, host?: string, localAddress?: string, socketStreamFactory?: () => stream.Duplex }, multiSubnetFailover: boolean) {
    this.options = options;
  ...
  executeForStream(socketStreamFactory: () => stream.Duplex, cb: (err: Error | null, socket?: stream.Duplex) => void) {
